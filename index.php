        ...
        <div class="col-md-6 text-md-start text-center mb-4 mb-md-0">
          ...
          <p class="gcam-content mb-4 fs-2 fw-bold">
            <span style="font-size: 16px; vertical-align: top">$</span>69<span
              style="font-size: 14px; vertical-align: super"
              >99</span
            >
          </p>
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-6 text-md-start text-center mb-4 mb-md-0">
          ...
          <p class="laptop-content mb-4 fs-2 fw-bold">
            ...
            >1,899<span style="font-size: 14px; vertical-align: super">99</span>
          </p>
          <button class="btn btn-dark gcam-btn rounded-4 px-4 py-2">
            Show more
          </button>
        ...
        >
          <div class="card" style="width: 18rem">
            ...
            <div class="card-body">
              ...
              <a href="#" class="btn btn-dark rounded-4">More details</a>
            </div>
          </div>
        </div>
        <div
