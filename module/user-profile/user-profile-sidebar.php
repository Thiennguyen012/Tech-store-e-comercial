...
<div class="pv-profile-sidebar text-center shadow-sm">
    ...
    <nav class="nav flex-column align-items-start mt-4">
        ...
        <a class="nav-link <?php echo is_active('user-profile.php'); ?>" href="#" onclick="loadPage('module/user-profile/user-profile.php',this,'profile'); return false;">
            <i class="bi bi-person"></i> Account Information
        </a>
        <a class="nav-link <?php echo is_active('user-order.php'); ?>" href="#" onclick="loadPage('module/user-order/user-order.php',this,'order'); return false;">
        ...
        <a class="nav-link <?php echo is_active('notification.php'); ?>" href="#" onclick="loadPage('module/user-profile/notification.php',this,'notification'); return false;">
