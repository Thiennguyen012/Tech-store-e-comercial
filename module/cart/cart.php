...
<script>
    function checkCartBeforeCheckout() {
        ...
        if (!cartHasItem) {
            // Hiển thị modal thông báo giỏ hàng rỗng
...
<!-- Modal thông báo giỏ hàng rỗng -->
<div class="modal fade" id="emptyCartModal" tabindex="-1" aria-labelledby="emptyNotiLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="emptyNotiLabel">Cart Empty</h5>
