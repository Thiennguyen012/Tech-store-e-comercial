        ...
        <ul class="navbar-nav justify-content-center flex-grow-1 pe-3">
          ...
          <li class="nav-item dropdown mx-2">
            ...
            <ul class="dropmenu dropdown-menu mx-2" ;>
              <li><a class="dropdown-item" href="#" onclick="loadPage('module/product/product.php?category=laptop'); return false;">Laptop</a></li>
              <li><a class="dropdown-item" href="#" onclick="loadPage('module/product/product.php?category=camera'); return false;">Camera</a></li>
              <li><a class="dropdown-item" href="#" onclick="loadPage('module/product/product.php?category=accessories'); return false;">Accessories</a></li>
            </ul>
          </li>
          <li class="nav-item dropdown mx-2">
